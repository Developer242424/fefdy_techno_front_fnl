...
const WholeStageModal = ({ WholeStageonClose, Percentage, TopicData }) => {
    return (
        <div style={styles.backdrop}>
            <div style={styles.modal}>
                <div style={styles.content}>
                    ...
                    <h1 className="stage_score">
                        {Percentage}/100
                    </h1>
                </div>

                <audio src={StageModalMP3} autoPlay />
                <button className="btn btn-primary float-end" onClick={WholeStageonClose}>Close</button>
            </div>
        </div>
    );
};
...
export default WholeStageModal;
